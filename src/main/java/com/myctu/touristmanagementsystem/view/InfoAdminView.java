 ...
 * @author GIGABYTE
 */
public class InfoAdminView extends javax.swing.JFrame {

    /**
     * Creates new form AdminInformationView
     */
    public InfoAdminView() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InfoAdminView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InfoAdminView().setVisible(true);
            }
        });
    }
