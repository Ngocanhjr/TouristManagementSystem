 ...
 * @author GIGABYTE
 */
public class AdminInformationView extends javax.swing.JFrame {

    /**
     * Creates new form AdminInformationView
     */
    public AdminInformationView() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminInformationView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminInformationView().setVisible(true);
            }
        });
    }
